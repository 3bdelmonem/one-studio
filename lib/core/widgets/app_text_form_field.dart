  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: prefixWidget ?? (prefixIcon == null ? null : IconButton(onPressed: () {}, highlightColor: AppColors.transparent, splashColor: AppColors.transparent, icon: AppIcons.icon(size: 18, icon: prefixIcon!, color: AppColors.hintColor,),)),
        suffixIcon: suffixWidget ?? (suffixIcon == null? null : IconButton(onPressed: () {}, highlightColor: AppColors.transparent, splashColor: AppColors.transparent,icon: AppIcons.icon(size: 50, icon: suffixIcon!, color: Theme.of(context).hintColor,),)),
        prefix: prefix,
        suffix: suffix,
        border: border,
