...
class CircleContainer extends StatelessWidget {
  ...
  const CircleContainer({this.borderColor, this.noAlignment = false, this.clipBehavior = Clip.hardEdge, this.onTap, this.child, this.alignment, this.margin, this.padding, this.color, this.border, this.size = 100, this.boxShadow, super.key});
