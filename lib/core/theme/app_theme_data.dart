...
class AppThemeData {
  ...
  static AppBarTheme appBarTheme({required Color texColor, backgroundColor,}) => AppBarTheme(
    ...
    centerTitle: true,
    titleSpacing: 0,
    titleTextStyle: TextStyles.textViewBold20.copyWith(color: texColor, fontFamily: AppFont.fontFamily),
  ...
  static InputDecorationTheme inputDecorationTheme({
    ...
    enabledBorder: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(15.r)),
    focusedBorder: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(15.r)),
    disabledBorder: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(15.r)),
    errorBorder: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(15.r)),
    focusedErrorBorder: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(15.r)),
  );
  ...
  static CheckboxThemeData checkboxThemeData({required Color primaryColor}) => CheckboxThemeData(
    fillColor: WidgetStateProperty.resolveWith(
      (Set<WidgetState> states) => states.contains(WidgetState.selected)? primaryColor : AppColors.transparent,
    ),
    side: WidgetStateBorderSide.resolveWith(
      (Set<WidgetState> states) =>states.contains(WidgetState.selected) ? BorderSide.none : BorderSide(color: primaryColor, width: 1.5.r),
    ),
    checkColor: WidgetStateProperty.all(AppColors.cardColor),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5.r)),
  );

  static TabBarThemeData tabBarThemeData({required Color primaryColor, borderColor,}) => TabBarThemeData(
